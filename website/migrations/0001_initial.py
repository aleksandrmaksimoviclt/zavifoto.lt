# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-08-07 13:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aboutpage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.AboutPage')),
            ],
        ),
        migrations.CreateModel(
            name='AboutPagePhoto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_for_facebook', models.CharField(max_length=300)),
                ('image_for_facebook', models.ImageField(upload_to='seo/')),
                ('contactspage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.ContactsPage')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_for_facebook', models.CharField(max_length=300)),
                ('image_for_facebook', models.ImageField(upload_to='seo/')),
                ('faqpage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.FaqPage')),
            ],
        ),
        migrations.CreateModel(
            name='FAQPhoto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_for_facebook', models.CharField(max_length=300)),
                ('image_for_facebook', models.ImageField(upload_to='seo/')),
                ('pricepage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.PricePage')),
            ],
        ),
        migrations.CreateModel(
            name='PricePagePhoto',
