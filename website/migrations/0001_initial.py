# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-07-27 21:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('heading', redactor.fields.RedactorField()),
                ('heading_slug', redactor.fields.RedactorField()),
                ('message', redactor.fields.RedactorField()),
                ('e_mail', redactor.fields.RedactorField()),
                ('phone_number', redactor.fields.RedactorField()),
                ('top_text', redactor.fields.RedactorField()),
                ('photo', redactor.fields.RedactorField()),
                ('author', redactor.fields.RedactorField()),
                ('text_with_icons_on_left', redactor.fields.RedactorField()),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(default=django.utils.timezone.now)),
                ('heading', models.CharField(blank=True, max_length=100, null=True)),
                ('language', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='website.Language')),
            ],
            options={
